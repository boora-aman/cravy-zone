...
! function(jQuery, undefined) {
    ...
    var _ISM = _R.is_mobile(),
        ...
        abstorel = function(a, b) {
            var c = a.split("index.html"),
                d = b.split("index.html");
            c.pop();
            for (var e = 0; e < d.length; e++) "." != d[e] && (".." == d[e] ? c.pop() : c.push(d[e]));
            return c.join("index.html")
        },
            ...
            a.find("img,.defaultimg, .tp-svg-layer").each(function() {
                ...
                if (c.data("loaded") === undefined && f !== undefined && f.progress && f.progress.match(/loaded/g)) {
                    if (c.attr("src", f.src), "img" == f.type)
                        if (c.hasClass("defaultimg")) _R.isIE(8) ? defimg.attr("src", f.src) : -1 == f.src.indexOf("images/transparent.html") && -1 == f.src.indexOf("assets/transparent.html") || c.data("bgcolor") === undefined ? c.css({
